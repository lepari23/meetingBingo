...
function detectWin(state = boardState) {
  ...
  for (let i = 0; i < boardWidth; i++) {
    ...
    if (!normal_diag_win && !back_diag_win && i === boardWidth - 1)
      return false; // short-circuits loop if diagonal is found
  }
...
if (typeof window !== "undefined") {
  ...
  if (typeof window !== "undefined") {
    ...
    let words =
      presetLists[key] || JSON.parse(localStorage.getItem(key) || "[]");
